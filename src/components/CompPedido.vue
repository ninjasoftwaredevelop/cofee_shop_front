  ...
  <div>
    <form id="pedido-form" method="POST" @submit="createPedido">
      <div class="input-container">
        ...
        <input type="text" id="cliente" name="cliente" v-model="cliente" placeholder="Digite o seu nome">
      </div>
      <div class="input-container">
        <label for="produto">Escolha a bebida :</label>
         <input type="text" id="nome" name="nome" v-model="produto" placeholder="Digite a bebida">
      </div>
      <div class="input-container">
